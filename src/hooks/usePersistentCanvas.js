...
function drawBox(ctx) {
  ...
  var canvasW = ctx.canvas.clientWidth;
  var canvasH = ctx.canvas.clientHeight;
  var rectW = canvasW / 2;
  var rectH = canvasH / 2;
  var centerOfCanvas = { x: canvasW / 2, y: canvasH / 2 };
  console.log(centerOfCanvas);
  ctx.beginPath();
  ctx.rect(
    centerOfCanvas.x - rectW / 2,
    centerOfCanvas.y - rectH / 2,
    rectW,
    rectH
  );
  ctx.stroke();
